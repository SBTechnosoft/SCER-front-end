...
function emailSmsModalController($scope, $modalInstance,$rootScope,$http,apiCall,apiPath,$timeout,clientArrayData,emailSMS) {
  'use strict';
...
emailSmsModalController.$inject = ["$scope", "$modalInstance","$rootScope","$http","apiCall","apiPath","$timeout","clientArrayData","emailSMS"];
