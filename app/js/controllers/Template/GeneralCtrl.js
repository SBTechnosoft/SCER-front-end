  ...
  // $scope.tempType  = tempType;
	 ...
	 $rootScope.$on('$viewContentLoaded', function() {
      ...
      tinymce.init({
	   ...
	   theme: 'modern',
        ...
        newmenu: {title : 'Setting', items : 'item1 item22 item35 item2 item31 item36 item37 item32 item33 item3 item4 item5 item6 item7 item8 item9 item10 item27 item28 item29 item11 item30 item34 item16 item17 item18 item19 item20 item21 item23 item24 item25 item27 item26 item38'}
       },
	...
	$scope.addUpTemplate = function()
	{
		if($scope.tempID){
			...
			formdata.append('companyId',$scope.generalTemp.companyDropDown.companyId);
			formdata.append('templateName',$scope.generalTemp.tempName);
			formdata.append('templateType','quotation');
			formdata.append('templateBody',tinyMCE.get('textdesc').getContent());
			//formdata.append('templateType',addBranch.branchName);
