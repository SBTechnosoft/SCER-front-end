...
App.controller('AccSpecialJrnlTableModalController', ["$scope", "$modal", "$log","$rootScope", function ($scope, $modal, $log,$rootScope) {
  'use strict';
  ...
  $scope.open = function (size) {
    ...
    var modalInstance = $modal.open({
      templateUrl: '/AccSpecialJrnlTableModalContent.html',
