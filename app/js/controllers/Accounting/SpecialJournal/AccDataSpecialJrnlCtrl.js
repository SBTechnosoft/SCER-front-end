...
function AccDataSpecialJrnlController($rootScope,$scope, $filter, ngTableParams,$http,apiCall,apiPath,$location) {
  'use strict';
  var vm = this;
  var data = [];
...
AccDataSpecialJrnlController.$inject = ["$rootScope","$scope", "$filter", "ngTableParams","$http","apiCall","apiPath","$location"];