...
App.controller('AccViewCreditNotesController', AccViewCreditNotesController);

function AccViewCreditNotesController($scope,toaster,apiCall,apiPath) {
  'use strict';
...
AccViewCreditNotesController.$inject = ["$scope","toaster","apiCall","apiPath"];