...
App.controller('AccDataCreditNotesController', AccDataCreditNotesController);

function AccDataCreditNotesController($rootScope,$scope, $filter, ngTableParams,$http,apiCall,apiPath,$location) {
  'use strict';
  var vm = this;
  var data = [];
...
AccDataCreditNotesController.$inject = ["$rootScope","$scope", "$filter", "ngTableParams","$http","apiCall","apiPath","$location"];