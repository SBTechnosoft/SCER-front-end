...
App.controller('AccViewDebitNotesController', AccViewDebitNotesController);

function AccViewDebitNotesController($scope,toaster,apiCall,apiPath) {
  'use strict';
...
AccViewDebitNotesController.$inject = ["$scope","toaster","apiCall","apiPath"];