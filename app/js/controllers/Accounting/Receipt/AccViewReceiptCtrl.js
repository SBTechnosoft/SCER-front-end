...
App.controller('AccViewReceiptController', AccViewReceiptController);

function AccViewReceiptController($scope,toaster,apiCall,apiPath) {
  'use strict';
...
AccViewReceiptController.$inject = ["$scope","toaster","apiCall","apiPath"];