...
function InvStockController($scope, $filter, ngTableParams) {
  'use strict';
  var vm = this;
	//$scope.brandradio="";
 ...
 // Chosen data
  ...
  vm.tableParams = new ngTableParams({
      ...
      getData: function($defer, params) {
		  ...
		  if(!$.isEmptyObject(params.$params.filter) && ((typeof(params.$params.filter.name) != "undefined" && params.$params.filter.name != "")  || (typeof(params.$params.filter.category) != "undefined" && params.$params.filter.category != "") || (typeof(params.$params.filter.group) != "undefined" && params.$params.filter.group != "") ))
		  {
...
InvStockController.$inject = ["$scope", "$filter", "ngTableParams"];