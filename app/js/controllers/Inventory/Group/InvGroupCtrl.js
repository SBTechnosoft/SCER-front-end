...
function InvGroupController($scope,$filter,$timeout,$templateCache,ngTableParams) {
...
InvGroupController.$inject = ["$scope", "$filter","$timeout","$templateCache","ngTableParams"];